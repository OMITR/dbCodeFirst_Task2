        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TownId = table.Column<int>(nullable: false),
                    PrimaryTeamColorColorId = table.Column<int>(nullable: true),
                    SecondaryTeamColorColorId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.PrimaryTeamColorColorId,
                        principalTable: "Colors",
                        principalColumn: "ColorId");
                    table.ForeignKey(
                        name: "FK_Teams_Colors_SecondaryTeamColorColorId",
                        column: x => x.SecondaryTeamColorColorId,
                        principalTable: "Colors",
                        principalColumn: "ColorId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PlayerId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IsInjured = table.Column<string>(nullable: true),
                    Name = table.Column<string>(maxLength: 64, nullable: true),
