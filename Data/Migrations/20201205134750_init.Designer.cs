...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Betting.Data.Models.Team", b =>
                {
                    ...
                    b.Property<int?>("PrimaryTeamColorColorId")
                        .HasColumnType("int");

                    b.Property<int>("SecondaryKitColorId")
                        .HasColumnType("int");

                    b.Property<int?>("SecondaryTeamColorColorId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PrimaryTeamColorColorId");

                    b.HasIndex("SecondaryTeamColorColorId");
            ...
            modelBuilder.Entity("Betting.Data.Models.Team", b =>
                {
                    b.HasOne("Betting.Data.Models.Color", "PrimaryTeamColor")
                        .WithMany("PrimaryKitColor")
                        .HasForeignKey("PrimaryTeamColorColorId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Betting.Data.Models.Color", "SecondaryTeamColor")
                        .WithMany("SecondaryKitColor")
                        .HasForeignKey("SecondaryTeamColorColorId")
                        .OnDelete(DeleteBehavior.NoAction);
